...
# DBTITLE 1,Accessing keyvault
dbutils.secrets.list('efnkvault')

# COMMAND ----------

dbusername=dbutils.secrets.get('efnkvault','efnsqlusername')

# COMMAND ----------

dbpwd=dbutils.secrets.get('efnkvault','efnsqlpassword')

# COMMAND ----------

jdbc_url = "jdbc:sqlserver://efnsqlserver.database.windows.net:1433;databaseName=efnsql"
